...
$config['facebook_app_id']              = '501421100284979';
$config['facebook_app_secret']          = 'b58cb5a7a43f320169d591921318c148';
$config['facebook_login_type']          = 'web';
$config['facebook_login_redirect_url']  = 'index.php/Signin';
$config['facebook_logout_redirect_url'] = 'index.php/Home';
$config['facebook_permissions']         = array('public_profile','user_photos');
